            ...
            .done(function(obj) {
                ...
                if (show_enforced_quantity_message) {
                    self.state.feedbackMessage = Utils.translate(
                        '$(0) has been added to Quote Request.<br/><<a href="#" data-hashtag="#request-a-quote" data-touchpoint="customercenter" data-trigger="go-to-quote">Please Click to Request Quote</a><br>Quantity: $(1). (Enforced minimum quantity)',
                        product_name,
                        quantity_to_add
                    );
                } else {
                    self.state.feedbackMessage = Utils.translate(
                        '$(0) has been added to Quote Request.<br/><a href="#" data-hashtag="#request-a-quote" data-touchpoint="customercenter" data-trigger="go-to-quote">Please Click to Request Quote</a><br>Quantity: $(1)',
                        product_name,
                        quantity_to_add
                    );
                }
