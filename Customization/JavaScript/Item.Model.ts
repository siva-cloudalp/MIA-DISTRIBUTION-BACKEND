...
import ItemOptionCollection = require('../../../Commons/Item/JavaScript/Item.Option.Collection');
...
const ItemModel = BackboneCachedModel.extend({
    ...
    getKeyMapping: function getKeyMapping() {
        if (!this._keyMapping) {
            this._keyMapping = _.defaults(
                Configuration.itemKeyMapping || {},
                ItemKeyMapping.getKeyMapping(Configuration)
            );
        }
