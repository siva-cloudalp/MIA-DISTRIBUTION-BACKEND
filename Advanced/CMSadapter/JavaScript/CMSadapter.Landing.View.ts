...
export = BackboneView.extend({
    ...
    //    setTimeout(function(){
    //        $('.value-add-page').parentsUntil('.cms-landing-page').parent().addClass('Value-add-services-main-cms-content') ;
    //        $('.get-in-touch').parentsUntil('.cms-landing-page').parent().addClass('Value-add-services-main-cms-content') ;
    //     }, 500);
    //     });
